      ...
      <BrowserRouter>
        <div className='App' style={textStyle}>
          ...
          <Switch>
            ...
            <Route exact path='/hw1' component={Homeworktable} />
            <Route exact path='/hw2' component={Homeworkcounter} />
            <Route exact path='/hw3' component={Homeworkmodal} />
            <Route exact path='/hw4' component={Homeworkgithub} />
            <Route
              exact
              path='/login'
              render={props => (
